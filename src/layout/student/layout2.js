    ...
    <div>
      <CssBaseline />
        <div style={{display:'flex',flexDirection:'column'}}>
          ...
          <div>
            <List>
              <ListItem selected={selected == "/dashboard" ? 1 : 0}>
               <ListItemIcon className={classes.sideicon} ><SchoolIcon /></ListItemIcon>
               <ListItemText secondary={"My Class"} />   
              </ListItem>
            </List>
          </div>
          ...
          <List>
              <ListItem selected={selected == "/student-video" ? 1 : 0} onClick={() => routeChange('/student-video')}>
                <ListItemIcon className={classes.sideicon}><MovieCreationIcon /></ListItemIcon>
                <ListItemText secondary={"Video"} />
              </ListItem>
              <ListItem selected={selected == "/student-assignment" || selected =="/submit" ? 1 : 0} onClick={() => routeChange('/student-assignment')}>
      ...
      <AppBar position="fixed" className={classes.appBar}>
        <Toolbar>
          ...
          <div style={{display: 'flex' , flexDirection :'column' , alignItems :'flex-end'}}>
            <Typography className={classes.topbar_text}>
