...
export default function FullWidthGrid() {
  ...
  return (
    <div className={classes.roots}> 
      ...
      onClick={() => routeChange('/student-assignment')}>
      ...
      <div className={classes.dialog_box}>
        ...
        <div className={classes.dialog_box}>
          ...
          <div className={classes.upload_options}>
            <Paper elevation={0} style={{border:'1px dashed #707070',height:'120px',width:'200px',marginTop:'15px'}}>
              <PhotoOutlinedIcon color={'#000000'} style={{opacity:'0.54',position:'relative',left:'50%',transform:'translateX(-50%)',top:'15%'}} />
              <div style={{position:'relative',top:'10%',textAlign:'center'}}>
              <Typography variant="body1" style={{fontWeight:'600',opacity:'0.54',color:'#000000'}}>
                click to upload
              </Typography>
              <Typography variant="caption" style={{fontWeight:'600',opacity:'0.54',color:'#000000'}}>
                maximage size 5Mb
              </Typography>
              </div>
            </Paper>
            <Paper elevation={0} className={classes.dashed_box}>
              <AddOutlinedIcon color={'#000000'} style={{opacity:'0.54',position:'relative',left:'50%',transform:'translateX(-50%)',top:'25%'}} />
            ...
            <Button style={{marginTop:'15px',marginBottom:'20px'}} variant="contained" color="primary">
              Submit
            </Button>
        </div>
    </div>
